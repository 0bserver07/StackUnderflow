...
def _match(
    *,
    ...
    project_path: str | None = "/Users/x/app",
    provider: str = "claude",
    first_ts: str | None = "2026-04-29T10:00:00Z",
    last_ts: str | None = "2026-04-29T11:00:00Z",
    message_count: int = 4,
