...
PINNED = {
    "stackunderflow/__version__.py": "0.9.2-dev.003",
    "pyproject.toml": "0.9.2-dev.003",
    "stackunderflow-ui/package.json": "0.9.2-dev.003",
    "stackunderflow-ui/package-lock.json": "0.9.2-dev.003",
    "flake.nix": "0.9.2-dev.003",
}
