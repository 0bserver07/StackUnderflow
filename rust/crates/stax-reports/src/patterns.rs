...
//!    [`table_exists`](crate::mart_queries::table_exists) here would make every
...
/// [`scope::Instant`](crate::scope::Instant) makes it explicit: it is the only
...
///
/// **Not** [`table_exists`](crate::mart_queries::table_exists), which is
...
mod tests {
    ...
    fn the_view_guard_lets_the_partitioned_messages_object_through() {
        ...
        assert!(!crate::mart_queries::table_exists(&conn, "messages").expect("probe"));
    }
