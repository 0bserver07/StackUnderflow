...
//!
//! [`median`] is a second copy of [`crate::services::anomaly::median`] (batch C).
...
///
/// A transcription of [`crate::services::anomaly::median`]; see the module docs
...
mod tests {
    ...
    fn the_median_matches_the_anomaly_ports_copy() {
        ...
        for values in [
            ...
            assert_eq!(median(&values), crate::services::anomaly::median(&values));
        }
