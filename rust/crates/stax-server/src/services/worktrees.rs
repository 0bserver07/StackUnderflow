...
//!   [`super::mart_queries`], which owns the table-only spelling.
...
///
/// Not [`super::mart_queries::table_exists`], which is `type='table'`. The two
...
mod tests {
    ...
    fn table_or_view_exists_accepts_a_view_where_the_mart_queries_guard_would_not() {
        ...
        assert!(!crate::services::mart_queries::table_exists(&conn, "v").expect("probe"));
    }
