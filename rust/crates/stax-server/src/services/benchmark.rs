...
//!
//! The statistics live next door in [`super::benchmark_stats`]; this module is
...
use super::benchmark_stats as bs;
use super::outcome_attribution;
...
/// [`super::mart_queries::table_exists`]'s `type='table'`, and the difference is
...
#[cfg(test)]
pub(crate) const FIXTURE_SQL: &str = r#"CREATE TABLE projects (id INTEGER PRIMARY KEY, slug TEXT);
...
mod tests {
    ...
    fn fixture_scope() -> crate::services::scope::Scope {
        crate::services::scope::parse_period(
            "all",
            crate::services::scope::Instant::from_parts(2026, 7, 31, 12, 0, 0, 0),
        )
        .expect("a known spec")
    }
