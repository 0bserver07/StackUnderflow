//! `routes/pricing.py` — 1 endpoint, wave 5.
//!
//! | Item | Method | FastAPI path | axum path |
//! |---|---|---|---|
//! | `RS-5-094` | `GET` | `/api/pricing/doctor` | `/api/pricing/doctor` |
//!
//! **Status: not ported.** This file is the slot; the endpoint batch that owns
//! `routes/pricing.py` fills in the handlers and the [`register`] body, and
