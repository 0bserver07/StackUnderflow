//! `routes/static_analysis.py` — 1 endpoint, wave 5.
//!
//! | Item | Method | FastAPI path | axum path |
//! |---|---|---|---|
//! | `RS-5-107` | `GET` | `/api/static-analysis/session/{session_id}` | `/api/static-analysis/session/{session_id}` |
//!
//! **Status: not ported.** This file is the slot; the endpoint batch that owns
//! `routes/static_analysis.py` fills in the handlers and the [`register`] body, and
