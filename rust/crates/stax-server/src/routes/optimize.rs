...
//! |---|---|---|---|
//! | `RS-5-085` | `GET ` | `/api/optimize                 ` | `/api/optimize` |
//! | `RS-5-086` | `GET ` | `/api/optimize/prescriptions   ` | `/api/optimize/prescriptions` |
//! | `RS-5-087` | `POST` | `/api/optimize/claudemd-preview` | `/api/optimize/claudemd-preview` |
//!
//! **Status: not ported.** This file is the slot; the endpoint batch that owns
//! `routes/optimize.py` fills in the handlers and the [`register`] body, and
