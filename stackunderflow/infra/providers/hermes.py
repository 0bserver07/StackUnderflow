...
Hermes records the upstream provider directly on each message
...
- otherwise → fall back to AnthropicPricer (Hermes's common
...
class HermesPricer(ProviderPricer):
    ...
    def rates_for(
        ...
        # Default route is Anthropic — most Hermes deployments are
