...
function RichTooltip({ active, label, payload }: RichTooltipProps) {
  ...
  return (
    <div
      className="bg-gray-900 border border-gray-700 rounded-md p-2.5 text-xs shadow-lg"
      data-testid="token-stack-tooltip"
    >
      <div className="text-gray-200 font-medium mb-1.5">{label}</div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3 gap-2 flex-wrap">
        <h3 className="text-sm font-medium text-gray-300">Daily Token Composition</h3>
        <div
