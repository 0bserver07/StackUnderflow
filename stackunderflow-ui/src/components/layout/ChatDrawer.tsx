...
export default function ChatDrawer({ open, onClose }: ChatDrawerProps) {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-96 bg-gray-950 border-l border-gray-800 shadow-2xl z-40 flex flex-col">
      <div className="flex items-center justify-between px-3 py-2 border-b border-gray-800">
        <span className="text-sm font-medium text-gray-300">Ollama Chat</span>
        <button
          onClick={onClose}
